...
public class KalmanFilter
{
    ...
    public (Vector X, Matrix P) Solve(Matrix Phi_kSub1Tok, (Matrix H_k, Vector Z_k, Matrix R_k)? measurement = null)
    {
        var X_kSub1 = X;
        var P_kSub1 = P;
        var Q_kSub1 = Q;
        var X_kSub1Tok = Phi_kSub1Tok * X_kSub1;
        var P_kSub1Tok = Phi_kSub1Tok * P_kSub1 * Phi_kSub1Tok.Transpose() + Q_kSub1;
        if (!measurement.HasValue)
        {
            X = X_kSub1Tok;
            P = P_kSub1Tok;
