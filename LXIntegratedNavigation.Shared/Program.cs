...
//var lcRes = lc.SolveForwards(initPose, dynamicImuDatas, gnssDatas);
//var lcRes2 = lc.SolveForwards(lcRes.Last(), dynamicImuDatas.Reverse(), gnssDatas.Reverse());
//WritePoses(GetPathAtDesktop($"{Path.GetFileNameWithoutExtension(imuDatasPath)}InsResult_{DateTime.Now:yyMMddHHmmss}.csv"), lcRes2.Reverse());
//WriteLine("Done");
